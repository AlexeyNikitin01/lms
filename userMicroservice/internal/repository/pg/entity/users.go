...
var (
	userAllColumns            = []string{"id", "login", "password", "name", "surname", "email", "phone", "place_work", "position", "registered", "role", "url", "created_at", "updated_at", "deleted_at"}
	userColumnsWithoutDefault = []string{"login", "password", "url"}
