...
var LectureTableColumns = struct {
	...
	CreatedAt: "lectures.created_at",
	UpdatedAt: "lectures.updated_at",
	DeletedAt: "lectures.deleted_at",
}
...
var LectureWhere = struct {
	...
	CourseID:  whereHelperint64{field: "\"lectures\".\"course_id\""},
	Lecture:   whereHelperstring{field: "\"lectures\".\"lecture\""},
	CreatedAt: whereHelpertime_Time{field: "\"lectures\".\"created_at\""},
	UpdatedAt: whereHelpertime_Time{field: "\"lectures\".\"updated_at\""},
	DeletedAt: whereHelpernull_Time{field: "\"lectures\".\"deleted_at\""},
}
...
func (r *lectureR) GetCourse() *Course {
	if r == nil {
		return nil
	}
	return r.Course
...
func (r *lectureR) GetQuestions() QuestionSlice {
	if r == nil {
		return nil
	}
	return r.Questions
...
var (
	lectureAllColumns            = []string{"id", "title", "course_id", "lecture", "created_at", "updated_at", "deleted_at"}
	lectureColumnsWithoutDefault = []string{"title", "course_id", "lecture"}
	lectureColumnsWithDefault    = []string{"id", "created_at", "updated_at", "deleted_at"}
...
func (o *Lecture) Course(mods ...qm.QueryMod) courseQuery {
...
func (o *Lecture) Questions(mods ...qm.QueryMod) questionQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"questions\".\"lecture_id\"=?", o.ID),
	)
...
func (lectureL) LoadCourse(ctx context.Context, e boil.ContextExecutor, singular bool, maybeLecture interface{}, mods queries.Applicator) error {
	var slice []*Lecture
	var object *Lecture
...
func (lectureL) LoadQuestions(ctx context.Context, e boil.ContextExecutor, singular bool, maybeLecture interface{}, mods queries.Applicator) error {
	var slice []*Lecture
	var object *Lecture
	...
	query := NewQuery(
		qm.From(`questions`),
		qm.WhereIn(`questions.lecture_id in ?`, args...),
...
// SetCourse of the lecture to the related item.
// Sets o.R.Course to related.
// Adds o to related.R.Lectures.
func (o *Lecture) SetCourse(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Course) error {
	var err error
	if insert {
...
func (o *Lecture) AddQuestions(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Question) error {
	var err error
...
func Lectures(mods ...qm.QueryMod) lectureQuery {
	mods = append(mods, qm.From("\"lectures\""), qmhelper.WhereIsNull("\"lectures\".\"deleted_at\""))
	q := NewQuery(mods...)
...
func FindLecture(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Lecture, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"lectures\" where \"id\"=$1 and \"deleted_at\" is null", sel,
	)
...
func (o *Lecture) Delete(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if o == nil {
	...
	if hardDelete {
		...
		sql = fmt.Sprintf("UPDATE \"lectures\" SET %s WHERE \"id\"=$2",
			strmangle.SetParamNames("\"", "\"", 1, wl),
		)
		valueMapping, err := queries.BindMapping(lectureType, lectureMapping, append(wl, lecturePrimaryKeyColumns...))
		if err != nil {
			return 0, err
		}
...
func (q lectureQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if q.Query == nil {
...
func (o LectureSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if len(o) == 0 {
		return 0, nil
	}
	...
	if hardDelete {
		...
		wl := []string{"deleted_at"}
		sql = fmt.Sprintf("UPDATE \"lectures\" SET %s WHERE "+
			strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 2, lecturePrimaryKeyColumns, len(o)),
			strmangle.SetParamNames("\"", "\"", 1, wl),
		)
...
func LectureExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"lectures\" where \"id\"=$1 and \"deleted_at\" is null limit 1)"
